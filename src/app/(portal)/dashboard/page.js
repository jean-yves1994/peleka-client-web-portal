  ...
  return (
    <div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <div className="stat-card-icon brown">
            <Clock3 size={19} />
          </div>
        ...
        <div className="stat-card">
          ...
          <strong>
            {money(billing?.outstanding_balance, billing?.currency || "RWF")}
          </strong>
          <span>
            {billing?.customer_type === "premier"
              ? "Premier invoice balance"
              : "standard account"}
          </span>
        </div>
      </div>
      <div className="content-grid">
        <section className="panel large">
          ...
          {loading ? (
            ...
            <div className="empty-state">
              ...
              <span>Create your first delivery to get started.</span>
              <Link
              ...
              {shipments.map((s) => (
                ...
                >
                  ...
                  <div className="shipment-status">
                    ...
                    <small>{money(s.total_price, s.currency || "RWF")}</small>
                  </div>
        ...
        <section className="panel quick">
          ...
          <Link href="/dashboard/shipments/new" className="quick-action">
            <Plus size={19} />
            <div>
              <strong>Create shipment</strong>
              <span>Get a quote and book delivery</span>
            </div>
            <ArrowUpRight size={15} />
          </Link>
          <Link href="/dashboard/track" className="quick-action">
            <MapPinned size={19} />
            <div>
              <strong>Track shipment</strong>
              <span>See active deliveries</span>
            </div>
            <ArrowUpRight size={15} />
          </Link>
        </section>
